...
public class LolNetworkUtility {
    ...
    private final static String TAG= "lolnet";
    ...
    private static String LOL_BASE_URL = "https://api.sportradar.us/lol-t1/us/schedules/2017-08-05/results.json";
...
//            String team_2_country_code = team_2.getString("country_code");
            ...
            LolItem lolItem = new LolItem(dateandtimeofgame,season_name,team_1_name,team_2_name,tournament_type,tournament_name,team_1_abbreviation,team_2_abbreviation,team_1_qualifier,team_2_qualifier,team_1_home_score,team_2_home_score,team_1_home_score_period,team_2_home_score_period);
