...
//            }
       ...
       //     int home_score = mainObject.getJSONObject("sport_event_status").getInt("home_score");
            ...
            CsGoItem csGoItem = new CsGoItem(dateandtimeofgame,season_name,team_1_name,team_2_name,tournament_type,tournament_name,team_1_abbreviation,team_2_abbreviation,team_1_qualifier,team_2_qualifier,home_score,away_score);
