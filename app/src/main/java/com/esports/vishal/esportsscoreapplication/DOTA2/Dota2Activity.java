...
public class Dota2Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dota2);
    ...
    public ArrayList<Dota2Item> getDotaArrayList(){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.dota2, menu);
        return true;
    }
    ...
    public void fetchURL(){
        ...
        DotaNetworkUtility dota2NetworkUtility = new DotaNetworkUtility();
    ...
    class Dota2DataFetchTask extends AsyncTask<URL,Void,ArrayList<Dota2Item>>
    {
        ...
        protected ArrayList<Dota2Item> doInBackground(URL... params) {
            ...
            URL url = DotaNetworkUtility.makeURL();

            try {

                String json = DotaNetworkUtility.getResponseFromHttpUrl(url);
                dota2ItemArrayList = DotaNetworkUtility.parseJSON(json);
